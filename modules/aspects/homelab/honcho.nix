{ ... }: {
  flake.modules.nixos.homelab-honcho =
    { config, pkgs, ... }:
    let
      ...
      services.k3s.manifests.honcho.content = [
        ...
        }
        {
          ...
          data = {
            ...
            DERIVER_MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DERIVER_MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DERIVER_MODEL_CONFIG__TRANSPORT = "openai";
            DERIVER_WORKERS = "1";
            DIALECTIC_LEVELS__high__MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DIALECTIC_LEVELS__high__MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DIALECTIC_LEVELS__high__MODEL_CONFIG__TRANSPORT = "openai";
            DIALECTIC_LEVELS__low__MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DIALECTIC_LEVELS__low__MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DIALECTIC_LEVELS__low__MODEL_CONFIG__TRANSPORT = "openai";
            DIALECTIC_LEVELS__max__MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DIALECTIC_LEVELS__max__MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DIALECTIC_LEVELS__max__MODEL_CONFIG__TRANSPORT = "openai";
            DIALECTIC_LEVELS__medium__MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DIALECTIC_LEVELS__medium__MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DIALECTIC_LEVELS__medium__MODEL_CONFIG__TRANSPORT = "openai";
            DIALECTIC_LEVELS__minimal__MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DIALECTIC_LEVELS__minimal__MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DIALECTIC_LEVELS__minimal__MODEL_CONFIG__TRANSPORT = "openai";
            DREAM_ENABLED = "true";
            DREAM_DEDUCTION_MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DREAM_DEDUCTION_MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            DREAM_DEDUCTION_MODEL_CONFIG__TRANSPORT = "openai";
            DREAM_INDUCTION_MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            DREAM_INDUCTION_MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
            ...
            SUMMARY_MODEL_CONFIG__MODEL = "qwen3-4b-instruct-2507";
            SUMMARY_MODEL_CONFIG__OVERRIDES__BASE_URL = "http://llamacpp-chat.llamacpp.svc.cluster.local:8080/v1";
